/*global define */
define(['jquery', 'Minuta/Comments', 'Minuta/RelatedContent', 'Minuta/Proposals',  'introjs', 'Minuta/Config', 'spinjs', 'cookie'], function (jQuery, Comments, RelatedContent, Proposals, introJs, Config, Spinner) {
    'use strict';
