<?php
class JKOF_Top_Downloads_Widget extends WP_Widget
{
    /**
    ...
    public function __construct() {
        ...
        $this->wpdb = &$wpdb;
        parent::__construct(
            'jkof_top_downloads_widget', // Base ID
            'Onyx Files Top Downloads', // Name
            array( 'description' => 'Display the top downloaded files of all time' ) // Args
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        $topFiles    =    $this->wpdb->get_results(
            "SELECT * FROM " . $this->wpdb->prefix . "of_files ORDER BY `downloads` DESC LIMIT " . $file_count
        );
