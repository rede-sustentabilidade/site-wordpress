...
jQuery(function () {
  ...
  if (o.directChat.enable) {
    jQuery(o.directChat.contactToggleSelector).on('click', function () {
...
function _init() {
  ...
  jQuery.AdminLTE.layout = {
    ...
    fixSidebar: function () {
      ...
      if (!jQuery("body").hasClass("fixed")) {
        ...
        return;
      } else if (typeof jQuery.fn.slimScroll == 'undefined' && console) {
  ...
  jQuery.AdminLTE.tree = function (menu) {
    ...
    jQuery("li a", jQuery(menu)).on('click', function (e) {
  ...
  jQuery.AdminLTE.boxWidget = {
    ...
    activate: function () {
      ...
      jQuery(_this.selectors.collapse).on('click', function (e) {
        e.preventDefault();
        _this.collapse(jQuery(this));
      });

      //Listen for remove event triggers
      jQuery(_this.selectors.remove).on('click', function (e) {
        e.preventDefault();
  ...
  jQuery.fn.todolist = function (options) {
    ...
    return this.each(function () {
      ...
      if (typeof jQuery.fn.iCheck != 'undefined') {
        ...
        jQuery('input', this).on('change', function (event) {
          var ele = jQuery(this).parents("li").first();
          ele.toggleClass("done");
          settings.onCheck.call(ele);
        });
