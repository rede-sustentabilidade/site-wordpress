			...
			foreach($useSliders as $slider){
				...
				<tr <?php echo $rowClass?>>
					...
					<td>
						...
						<!--a class="button-primary revcarrot export_slider_standalone" id="export_slider_standalone_<?php echo $id?>" href="javascript:void(0);" title=""><i class="revicon-export"></i><?php _e("Standalone Export",REVSLIDER_TEXTDOMAIN)?></a-->
