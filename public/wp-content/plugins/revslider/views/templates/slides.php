	...
	<div class="wrap settings_wrap">
		...
		<span class="loader_round new_trans_slide_loader" style="display:none"><?php _e("Adding Slide...",REVSLIDER_TEXTDOMAIN)?></span>		
		<span class="hor_sap_double"></span>
		<!--a class='button-primary revgreen' href='<?php echo self::getViewUrl(RevSliderAdmin::VIEW_SLIDE,"id=static"); ?>' style="width:150px; "><i class="revicon-pencil-1"></i><?php _e("Edit Static Layers",REVSLIDER_TEXTDOMAIN)?></a-->
		<span class="hor_sap_double"></span>
