/*global define */
define(['jquery', 'Minuta/FormComments', 'Minuta/Config', 'spinjs', 'moment', 'moment_br'],
    function (jQuery, FormComments, Config, Spinner, moment) {
    'use strict';
    ...
    var Comments = {
        ...
        formatOpinion : function (opinion) {
            switch (opinion) {
            case 'concordo':
                return '<i class="minuta-icon-agree" title="Concordo com o Dispositivo"></i>';
            case 'concordo-com-ressalvas':
                return '<i class="minuta-icon-so-so" title="Concordo com o Dispositivo com ressalvas"></i>';
            case 'nao-concordo':
                return '<i class="minuta-icon-not-agree" title="Discordo do Dispositivo"></i>';
            default:
                return opinion;
            }
        },
        ...
        formatProposal : function (proposal) {
            switch (proposal) {
            case 'alteracao':
                return '<i class="minuta-icon-text-change" title="Alteração no texto"></i>';

            case 'exclusao':
                return '<i class="minuta-icon-text-remove" title="Exclusão do dispositivo"></i>';

            case 'retorno':
                return '<i class="minuta-icon-text-return" title="Proposta de nova redação"></i>';

            case 'acrescimo':
                return '<i class="minuta-icon-text-add" title="Acréscimo de um novo dispositivo"></i>';
        ...
        init : function () {
            ...
            jQuery('.comment-pp').on('click', function () {
                ...
                var head0 = jQuery('#site-navigation').height();
                var head1 = jQuery('.menubar').height();
//                var margin = head0 + head1;

                var margin = jQuery(document).scrollTop()-head0 - head1;
