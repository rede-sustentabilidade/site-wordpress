...
define(['jquery', 'countable'], function (jQuery, Countable) {
    ...
    var FormComments = {
        ...
        init : function () {
            ...
            jQuery('.comment-pp p').on('click', function () {
                ...
                if (obj.find('form select').size() === 0) {
                    ...
                    '        <li class="last">'+
                    '            <a href="#" class="cancel-comment">cancelar</a>'+
                    '            <a href="#" class="send-comment">enviar comentário</a>'+
                    '        </li>'+
                    '    </ol>');
            ...
            var optCommentForm = {
                ...
                success: function (response, responseText) {
                    ...
                    msg.html('<p><strong>Agradecemos sua proposta, após a ' +
                             'moderação será disponibilizada nesta plataforma.</strong></p>');
                    msg.fadeIn();
                ...
                error: function (xhr, err) {
                    ...
                    msg.html('<p><strong>Ocorreu um erro ao tentar enviar o seu comentário. Tente novamente mais tarde.</strong></p>');
                    msg.fadeIn();
                    window.setTimeout(function () {
                        msg.fadeOut('slow');
                        p.removeClass('submitted');
        ...
        bindFormActions : function (obj) {
            obj.find('select').minimalect({ theme: 'bubble', placeholder: 'Sua opinião'});
