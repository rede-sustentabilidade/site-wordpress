  ...
  <form method="POST" id="newFiliado" style="display:<?php echo $display_filiado_form; ?>;" action="<?php echo admin_url( 'admin.php' ); ?>">
    ...
    <fieldset>
      ...
      <div class="input text alignleft">
        ...
        <input type="text" name="telefone_comercial" value="<?php echo $profile->telefone_celular; ?>">
      </div>
      ...
      <div class="input text alignleft">
        ...
        <select name="nacionalidade" required>
            <option value=""></option>
            <option class="level-0" value="Brasil - Brasileiro" <?php echo ($profile->status == 'Brasil - Brasileiro' ? 'selected=selected' : ''); ?>>Brasil - Brasileiro</option>
            <option class="level-0" value="Antígua e Barbuda - Antiguano" <?php echo ($profile->status == 'Antígua e Barbuda - Antiguano' ? 'selected=selected' : ''); ?>>Antígua e Barbuda - Antiguano</option>
            <option class="level-0" value="Argentina - Argentino" <?php echo ($profile->status == 'Argentina - Argentino' ? 'selected=selected' : ''); ?>>Argentina - Argentino</option>
            <option class="level-0" value="Bahamas - Bahamense" <?php echo ($profile->status == 'Bahamas - Bahamense' ? 'selected=selected' : ''); ?>>Bahamas - Bahamense</option>
            <option class="level-0" value="Barbados - Barbadiano, barbadense" <?php echo ($profile->status == 'Barbados - Barbadiano, barbadense' ? 'selected=selected' : ''); ?>>Barbados - Barbadiano, barbadense</option>
            <option class="level-0" value="Belize - Belizenho" <?php echo ($profile->status == 'Belize - Belizenho' ? 'selected=selected' : ''); ?>>Belize - Belizenho</option>
            <option class="level-0" value="Bolívia - Boliviano" <?php echo ($profile->status == 'Bolívia - Boliviano' ? 'selected=selected' : ''); ?>>Bolívia - Boliviano</option>
            <option class="level-0" value="Chile - Chileno" <?php echo ($profile->status == 'Chile - Chileno' ? 'selected=selected' : ''); ?>>Chile - Chileno</option>
            <option class="level-0" value="Colômbia - Colombiano" <?php echo ($profile->status == 'Colômbia - Colombiano' ? 'selected=selected' : ''); ?>>Colômbia - Colombiano</option>
            <option class="level-0" value="Costa Rica - Costarriquenho" <?php echo ($profile->status == 'Costa Rica - Costarriquenho' ? 'selected=selected' : ''); ?>>Costa Rica - Costarriquenho</option>
            <option class="level-0" value="Cuba - Cubano" <?php echo ($profile->status == 'Cuba - Cubano' ? 'selected=selected' : ''); ?>>Cuba - Cubano</option>
            <option class="level-0" value="Dominica - Dominicano" <?php echo ($profile->status == 'Dominica - Dominicano' ? 'selected=selected' : ''); ?>>Dominica - Dominicano</option>
            <option class="level-0" value="Equador - Equatoriano" <?php echo ($profile->status == 'Equador - Equatoriano' ? 'selected=selected' : ''); ?>>Equador - Equatoriano</option>
            <option class="level-0" value="El Salvador - Salvadorenho" <?php echo ($profile->status == 'El Salvador - Salvadorenho' ? 'selected=selected' : ''); ?>>El Salvador - Salvadorenho</option>
            <option class="level-0" value="Granada - Granadino" <?php echo ($profile->status == 'Granada - Granadino' ? 'selected=selected' : ''); ?>>Granada - Granadino</option>
            <option class="level-0" value="Guatemala - Guatemalteco" <?php echo ($profile->status == 'Guatemala - Guatemalteco' ? 'selected=selected' : ''); ?>>Guatemala - Guatemalteco</option>
            <option class="level-0" value="Guiana - Guianês" <?php echo ($profile->status == 'Guiana - Guianês' ? 'selected=selected' : ''); ?>>Guiana - Guianês</option>
            <option class="level-0" value="Guiana Francesa - Guianense" <?php echo ($profile->status == 'Guiana Francesa - Guianense' ? 'selected=selected' : ''); ?>>Guiana Francesa - Guianense</option>
            <option class="level-0" value="Haiti - Haitiano" <?php echo ($profile->status == 'Haiti - Haitiano' ? 'selected=selected' : ''); ?>>Haiti - Haitiano</option>
            <option class="level-0" value="Honduras - Hondurenho" <?php echo ($profile->status == 'Honduras - Hondurenho' ? 'selected=selected' : ''); ?>>Honduras - Hondurenho</option>
            <option class="level-0" value="Jamaica - Jamaicano" <?php echo ($profile->status == 'Jamaica - Jamaicano' ? 'selected=selected' : ''); ?>>Jamaica - Jamaicano</option>
            <option class="level-0" value="México - Mexicano" <?php echo ($profile->status == 'México - Mexicano' ? 'selected=selected' : ''); ?>>México - Mexicano</option>
            <option class="level-0" value="Nicarágua - Nicaraguense" <?php echo ($profile->status == 'Nicarágua - Nicaraguense' ? 'selected=selected' : ''); ?>>Nicarágua - Nicaraguense</option>
            <option class="level-0" value="Panamá - Panamenho" <?php echo ($profile->status == 'Panamá - Panamenho' ? 'selected=selected' : ''); ?>>Panamá - Panamenho</option>
            <option class="level-0" value="Paraguai - Paraguaio" <?php echo ($profile->status == 'Paraguai - Paraguaio' ? 'selected=selected' : ''); ?>>Paraguai - Paraguaio</option>
            <option class="level-0" value="Peru - Peruano" <?php echo ($profile->status == 'Peru - Peruano' ? 'selected=selected' : ''); ?>>Peru - Peruano</option>
            <option class="level-0" value="Porto Rico - Portorriquenho" <?php echo ($profile->status == 'Porto Rico - Portorriquenho' ? 'selected=selected' : ''); ?>>Porto Rico - Portorriquenho</option>
            <option class="level-0" value="República Dominicana - Dominicana" <?php echo ($profile->status == 'República Dominicana - Dominicana' ? 'selected=selected' : ''); ?>>República Dominicana - Dominicana</option>
            <option class="level-0" value="São Cristóvão e Nevis - São-cristovense" <?php echo ($profile->status == 'São Cristóvão e Nevis - São-cristovense' ? 'selected=selected' : ''); ?>>São Cristóvão e Nevis - São-cristovense</option>
            <option class="level-0" value="São Vicente e Granadinas - São-vicentino" <?php echo ($profile->status == 'São Vicente e Granadinas - São-vicentino' ? 'selected=selected' : ''); ?>>São Vicente e Granadinas - São-vicentino</option>
            <option class="level-0" value="Santa Lúcia - Santa-lucense" <?php echo ($profile->status == 'Santa Lúcia - Santa-lucense' ? 'selected=selected' : ''); ?>>Santa Lúcia - Santa-lucense</option>
            <option class="level-0" value="Suriname - Surinamês" <?php echo ($profile->status == 'Suriname - Surinamês' ? 'selected=selected' : ''); ?>>Suriname - Surinamês</option>
            <option class="level-0" value="Trinidad e Tobago - Trindadense" <?php echo ($profile->status == 'Trinidad e Tobago - Trindadense' ? 'selected=selected' : ''); ?>>Trinidad e Tobago - Trindadense</option>
            <option class="level-0" value="Uruguai - Uruguaio" <?php echo ($profile->status == 'Uruguai - Uruguaio' ? 'selected=selected' : ''); ?>>Uruguai - Uruguaio</option>
            <option class="level-0" value="Venezuela - Venezuelano" <?php echo ($profile->status == 'Venezuela - Venezuelano' ? 'selected=selected' : ''); ?>>Venezuela - Venezuelano</option>
            <option class="level-0" value="Alemanha - Alemão" <?php echo ($profile->status == 'Alemanha - Alemão' ? 'selected=selected' : ''); ?>>Alemanha - Alemão</option>
            <option class="level-0" value="Áustria - Austríaco" <?php echo ($profile->status == 'Áustria - Austríaco' ? 'selected=selected' : ''); ?>>Áustria - Austríaco</option>
            <option class="level-0" value="Bélgica - Belga" <?php echo ($profile->status == 'Bélgica - Belga' ? 'selected=selected' : ''); ?>>Bélgica - Belga</option>
            <option class="level-0" value="Croácia - Croata" <?php echo ($profile->status == 'Croácia - Croata' ? 'selected=selected' : ''); ?>>Croácia - Croata</option>
            <option class="level-0" value="Dinamarca - Dinamarquês" <?php echo ($profile->status == 'Dinamarca - Dinamarquês' ? 'selected=selected' : ''); ?>>Dinamarca - Dinamarquês</option>
            <option class="level-0" value="Eslováquia - Eslovaco" <?php echo ($profile->status == 'Eslováquia - Eslovaco' ? 'selected=selected' : ''); ?>>Eslováquia - Eslovaco</option>
            <option class="level-0" value="Eslovênia - Esloveno" <?php echo ($profile->status == 'Eslovênia - Esloveno' ? 'selected=selected' : ''); ?>>Eslovênia - Esloveno</option>
            <option class="level-0" value="Espanha - Espanhol" <?php echo ($profile->status == 'Espanha - Espanhol' ? 'selected=selected' : ''); ?>>Espanha - Espanhol</option>
            <option class="level-0" value="França - Francês" <?php echo ($profile->status == 'França - Francês' ? 'selected=selected' : ''); ?>>França - Francês</option>
            <option class="level-0" value="Grécia - Grego" <?php echo ($profile->status == 'Grécia - Grego' ? 'selected=selected' : ''); ?>>Grécia - Grego</option>
            <option class="level-0" value="Hungria - Húngaro" <?php echo ($profile->status == 'Hungria - Húngaro' ? 'selected=selected' : ''); ?>>Hungria - Húngaro</option>
            <option class="level-0" value="Irlanda - Irlandês" <?php echo ($profile->status == 'Irlanda - Irlandês' ? 'selected=selected' : ''); ?>>Irlanda - Irlandês</option>
            <option class="level-0" value="Itália - Italiano" <?php echo ($profile->status == 'Itália - Italiano' ? 'selected=selected' : ''); ?>>Itália - Italiano</option>
            <option class="level-0" value="Noruega - Noruego" <?php echo ($profile->status == 'Noruega - Noruego' ? 'selected=selected' : ''); ?>>Noruega - Noruego</option>
            <option class="level-0" value="Países Baixos - Holandês" <?php echo ($profile->status == 'Países Baixos - Holandês' ? 'selected=selected' : ''); ?>>Países Baixos - Holandês</option>
            <option class="level-0" value="Polônia - Polonês" <?php echo ($profile->status == 'Polônia - Polonês' ? 'selected=selected' : ''); ?>>Polônia - Polonês</option>
            <option class="level-0" value="Portugal - Português" <?php echo ($profile->status == 'Portugal - Português' ? 'selected=selected' : ''); ?>>Portugal - Português</option>
            <option class="level-0" value="Reino Unido - Britânico" <?php echo ($profile->status == 'Reino Unido - Britânico' ? 'selected=selected' : ''); ?>>Reino Unido - Britânico</option>
            <option class="level-0" value="Inglaterra - Inglês" <?php echo ($profile->status == 'Inglaterra - Inglês' ? 'selected=selected' : ''); ?>>Inglaterra - Inglês</option>
            <option class="level-0" value="País de Gales - Galês" <?php echo ($profile->status == 'País de Gales - Galês' ? 'selected=selected' : ''); ?>>País de Gales - Galês</option>
            <option class="level-0" value="Escócia - Escocês" <?php echo ($profile->status == 'Escócia - Escocês' ? 'selected=selected' : ''); ?>>Escócia - Escocês</option>
            <option class="level-0" value="Romênia - Romeno" <?php echo ($profile->status == 'Romênia - Romeno' ? 'selected=selected' : ''); ?>>Romênia - Romeno</option>
            <option class="level-0" value="Rússia - Russo" <?php echo ($profile->status == 'Rússia - Russo' ? 'selected=selected' : ''); ?>>Rússia - Russo</option>
            <option class="level-0" value="Sérvio - Sérvio" <?php echo ($profile->status == 'Sérvio - Sérvio' ? 'selected=selected' : ''); ?>>Sérvio - Sérvio</option>
            <option class="level-0" value="Suécia - Sueco" <?php echo ($profile->status == 'Suécia - Sueco' ? 'selected=selected' : ''); ?>>Suécia - Sueco</option>
            <option class="level-0" value="Suíça - Suíço" <?php echo ($profile->status == 'Suíça - Suíço' ? 'selected=selected' : ''); ?>>Suíça - Suíço</option>
            <option class="level-0" value="Turquia - Turco" <?php echo ($profile->status == 'Turquia - Turco' ? 'selected=selected' : ''); ?>>Turquia - Turco</option>
            <option class="level-0" value="Ucrânia - Ucraniano" <?php echo ($profile->status == 'Ucrânia - Ucraniano' ? 'selected=selected' : ''); ?>>Ucrânia - Ucraniano</option>
            <option class="level-0" value="Estados Unidos - Americano" <?php echo ($profile->status == 'Estados Unidos - Americano' ? 'selected=selected' : ''); ?>>Estados Unidos - Americano</option>
            <option class="level-0" value="Canadá - Canadense" <?php echo ($profile->status == 'Canadá - Canadense' ? 'selected=selected' : ''); ?>>Canadá - Canadense</option>
            <option class="level-0" value="Angola - Angolano" <?php echo ($profile->status == 'Angola - Angolano' ? 'selected=selected' : ''); ?>>Angola - Angolano</option>
            <option class="level-0" value="Moçambique - Moçambicano" <?php echo ($profile->status == 'Moçambique - Moçambicano' ? 'selected=selected' : ''); ?>>Moçambique - Moçambicano</option>
            <option class="level-0" value="África do Sul - Sul-africano" <?php echo ($profile->status == 'África do Sul - Sul-africano' ? 'selected=selected' : ''); ?>>África do Sul - Sul-africano</option>
            <option class="level-0" value="Zimbabue - Zimbabuense" <?php echo ($profile->status == 'Zimbabue - Zimbabuense' ? 'selected=selected' : ''); ?>>Zimbabue - Zimbabuense</option>
            <option class="level-0" value="Argélia - Argélia" <?php echo ($profile->status == 'Argélia - Argélia' ? 'selected=selected' : ''); ?>>Argélia - Argélia</option>
            <option class="level-0" value="Comores - Comorense" <?php echo ($profile->status == 'Comores - Comorense' ? 'selected=selected' : ''); ?>>Comores - Comorense</option>
            <option class="level-0" value="Egito - Egípcio" <?php echo ($profile->status == 'Egito - Egípcio' ? 'selected=selected' : ''); ?>>Egito - Egípcio</option>
            <option class="level-0" value="Líbia - Líbio" <?php echo ($profile->status == 'Líbia - Líbio' ? 'selected=selected' : ''); ?>>Líbia - Líbio</option>
            <option class="level-0" value="Marrocos - Marroquino" <?php echo ($profile->status == 'Marrocos - Marroquino' ? 'selected=selected' : ''); ?>>Marrocos - Marroquino</option>
            <option class="level-0" value="Gana - Ganés" <?php echo ($profile->status == 'Gana - Ganés' ? 'selected=selected' : ''); ?>>Gana - Ganés</option>
            <option class="level-0" value="Quênia - Queniano" <?php echo ($profile->status == 'Quênia - Queniano' ? 'selected=selected' : ''); ?>>Quênia - Queniano</option>
            <option class="level-0" value="Ruanda - Ruandês" <?php echo ($profile->status == 'Ruanda - Ruandês' ? 'selected=selected' : ''); ?>>Ruanda - Ruandês</option>
            <option class="level-0" value="Uganda - Ugandense" <?php echo ($profile->status == 'Uganda - Ugandense' ? 'selected=selected' : ''); ?>>Uganda - Ugandense</option>
            <option class="level-0" value="Botsuana - Bechuano" <?php echo ($profile->status == 'Botsuana - Bechuano' ? 'selected=selected' : ''); ?>>Botsuana - Bechuano</option>
            <option class="level-0" value="Costa do Marfim - Marfinense" <?php echo ($profile->status == 'Costa do Marfim - Marfinense' ? 'selected=selected' : ''); ?>>Costa do Marfim - Marfinense</option>
            <option class="level-0" value="Camarões - Camaronense" <?php echo ($profile->status == 'Camarões - Camaronense' ? 'selected=selected' : ''); ?>>Camarões - Camaronense</option>
            <option class="level-0" value="Nigéria - Nigeriano" <?php echo ($profile->status == 'Nigéria - Nigeriano' ? 'selected=selected' : ''); ?>>Nigéria - Nigeriano</option>
            <option class="level-0" value="Somália - Somali" <?php echo ($profile->status == 'Somália - Somali' ? 'selected=selected' : ''); ?>>Somália - Somali</option>
            <option class="level-0" value="Austrália - Australiano" <?php echo ($profile->status == 'Austrália - Australiano' ? 'selected=selected' : ''); ?>>Austrália - Australiano</option>
            <option class="level-0" value="Nova Zelândia - Neozelandês" <?php echo ($profile->status == 'Nova Zelândia - Neozelandês' ? 'selected=selected' : ''); ?>>Nova Zelândia - Neozelandês</option>
            <option class="level-0" value="Afeganistão - Afegão" <?php echo ($profile->status == 'Afeganistão - Afegão' ? 'selected=selected' : ''); ?>>Afeganistão - Afegão</option>
            <option class="level-0" value="Arábia Saudita - Saudita" <?php echo ($profile->status == 'Arábia Saudita - Saudita' ? 'selected=selected' : ''); ?>>Arábia Saudita - Saudita</option>
            <option class="level-0" value="Armênia - Armeno" <?php echo ($profile->status == 'Armênia - Armeno' ? 'selected=selected' : ''); ?>>Armênia - Armeno</option>
            <option class="level-0" value="Armeno - Bangladesh" <?php echo ($profile->status == 'Armeno - Bangladesh' ? 'selected=selected' : ''); ?>>Armeno - Bangladesh</option>
            <option class="level-0" value="China - Chinês" <?php echo ($profile->status == 'China - Chinês' ? 'selected=selected' : ''); ?>>China - Chinês</option>
            <option class="level-0" value="Coréia do Norte - Norte-coreano, coreano" <?php echo ($profile->status == 'Coréia do Norte - Norte-coreano, coreano' ? 'selected=selected' : ''); ?>>Coréia do Norte - Norte-coreano, coreano</option>
            <option class="level-0" value="Coréia do Sul - Sul-coreano, coreano" <?php echo ($profile->status == 'Coréia do Sul - Sul-coreano, coreano' ? 'selected=selected' : ''); ?>>Coréia do Sul - Sul-coreano, coreano</option>
            <option class="level-0" value="Índia - Indiano" <?php echo ($profile->status == 'Índia - Indiano' ? 'selected=selected' : ''); ?>>Índia - Indiano</option>
            <option class="level-0" value="Indonésia - Indonésio" <?php echo ($profile->status == 'Indonésia - Indonésio' ? 'selected=selected' : ''); ?>>Indonésia - Indonésio</option>
            <option class="level-0" value="Iraque - Iraquiano" <?php echo ($profile->status == 'Iraque - Iraquiano' ? 'selected=selected' : ''); ?>>Iraque - Iraquiano</option>
            <option class="level-0" value="Irã - Iraniano" <?php echo ($profile->status == 'Irã - Iraniano' ? 'selected=selected' : ''); ?>>Irã - Iraniano</option>
            <option class="level-0" value="Israel - Israelita" <?php echo ($profile->status == 'Israel - Israelita' ? 'selected=selected' : ''); ?>>Israel - Israelita</option>
            <option class="level-0" value="Japão - Japonês" <?php echo ($profile->status == 'Japão - Japonês' ? 'selected=selected' : ''); ?>>Japão - Japonês</option>
            <option class="level-0" value="Malásia - Malaio" <?php echo ($profile->status == 'Malásia - Malaio' ? 'selected=selected' : ''); ?>>Malásia - Malaio</option>
            <option class="level-0" value="Nepal - Nepalês" <?php echo ($profile->status == 'Nepal - Nepalês' ? 'selected=selected' : ''); ?>>Nepal - Nepalês</option>
            <option class="level-0" value="Omã - Omanense" <?php echo ($profile->status == 'Omã - Omanense' ? 'selected=selected' : ''); ?>>Omã - Omanense</option>
            <option class="level-0" value="Paquistão - Paquistanês" <?php echo ($profile->status == 'Paquistão - Paquistanês' ? 'selected=selected' : ''); ?>>Paquistão - Paquistanês</option>
            <option class="level-0" value="Palestina - Palestino" <?php echo ($profile->status == 'Palestina - Palestino' ? 'selected=selected' : ''); ?>>Palestina - Palestino</option>
            <option class="level-0" value="Qatar - Qatarense" <?php echo ($profile->status == 'Qatar - Qatarense' ? 'selected=selected' : ''); ?>>Qatar - Qatarense</option>
            <option class="level-0" value="Síria - Sírio" <?php echo ($profile->status == 'Síria - Sírio' ? 'selected=selected' : ''); ?>>Síria - Sírio</option>
            <option class="level-0" value="Sri Lanka - Cingalês" <?php echo ($profile->status == 'Sri Lanka - Cingalês' ? 'selected=selected' : ''); ?>>Sri Lanka - Cingalês</option>
            <option class="level-0" value="Tailândia - Tailandês" <?php echo ($profile->status == 'Tailândia - Tailandês' ? 'selected=selected' : ''); ?>>Tailândia - Tailandês</option>
            <option class="level-0" value="Timor-Leste - Timorense, maubere" <?php echo ($profile->status == 'Timor-Leste - Timorense, maubere' ? 'selected=selected' : ''); ?>>Timor-Leste - Timorense, maubere</option>
            <option class="level-0" value="Emirados Árabes Unidos - Árabe, emiratense" <?php echo ($profile->status == 'Emirados Árabes Unidos - Árabe, emiratense' ? 'selected=selected' : ''); ?>>Emirados Árabes Unidos - Árabe, emiratense</option>
            <option class="level-0" value="Vietnã - Vietnamita" <?php echo ($profile->status == 'Vietnã - Vietnamita' ? 'selected=selected' : ''); ?>>Vietnã - Vietnamita</option>
            <option class="level-0" value="Iêmen - Iemenit" <?php echo ($profile->status == 'Iêmen - Iemenit' ? 'selected=selected' : ''); ?>>Iêmen - Iemenit</option>
        </select>
      </div>
    </fieldset>
